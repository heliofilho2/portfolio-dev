        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Metric1Name = table.Column<string>(type: "text", nullable: true),
                    Metric1Value = table.Column<string>(type: "text", nullable: true),
                    Metric2Name = table.Column<string>(type: "text", nullable: true),
                    Metric2Value = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Experiences_IsCurrent",
                table: "Experiences",
                column: "IsCurrent");

            migrationBuilder.CreateIndex(
                name: "IX_Experiences_StartDate_DisplayOrder",
                table: "Experiences",
